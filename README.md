...
- YouTube Shorts AutoScroll: userscript that automatically advances to the next short when the current one ends.
- YouTube Shorts AutoScroll Extension: Chrome extension version that advances to the next short when the current one finishes.
